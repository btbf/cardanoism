...
UI_JA: dict[str, str] = {
    ...
    "dashboard_drep_votes_title":         "委任先 DRep の直近投票",
    "dashboard_drep_votes_empty":         "委任先 DRep を設定すると投票履歴が表示されます",
    "dashboard_drep_no_votes":            "まだ投票がありません",
    ...
    "dashboard_rewards_title":            "ステーキング報酬",
    "dashboard_rewards_total":            "累積報酬",
    "dashboard_rewards_recent":           "直近 5 エポック",
    "dashboard_rewards_empty":            "報酬データがまだありません (報酬通知を ON にすると自動キャッシュされます)",
    "dashboard_rewards_missing_note":     "報酬通知 OFF のステークアドレスは履歴がキャッシュされません",
...
UI_EN: dict[str, str] = {
    ...
    "dashboard_drep_votes_title":         "Recent votes by your DReps",
    "dashboard_drep_votes_empty":         "Set a DRep delegation to see their voting history",
    "dashboard_drep_no_votes":            "No votes yet",
    ...
    "dashboard_rewards_title":            "Staking rewards",
    "dashboard_rewards_total":            "Cumulative",
    "dashboard_rewards_recent":           "Last 5 epochs",
    "dashboard_rewards_empty":            "No reward data yet (enable reward notifications to start caching)",
    "dashboard_rewards_missing_note":     "Stake addresses with reward notifications OFF are not cached",
