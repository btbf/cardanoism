...
UI_JA: dict[str, str] = {
    ...
    "ga_ai_section_subtitle": "Claude Sonnet による憲法準拠と VISION 2030 KPI の自動評価",
    ...
    "ga_ai_state_analyzing_title":       "Claude が分析しています...",
    "ga_ai_state_analyzing_desc":        "憲法本文と提案メタデータを照合し、KPI スコアを算出中（通常 30〜60 秒）",
    ...
    "ga_ai_kpi_title":                   "VISION 2030 KPI 評価",
...
UI_EN: dict[str, str] = {
    ...
    "ga_ai_section_subtitle": "Auto-evaluation of constitutional compliance and VISION 2030 KPIs by Claude Sonnet",
    ...
    "ga_ai_state_analyzing_title":       "Claude is analyzing...",
    "ga_ai_state_analyzing_desc":        "Cross-referencing the constitution with proposal metadata and computing KPI scores (typically 30–60s)",
    ...
    "ga_ai_kpi_title":                   "VISION 2030 KPI Assessment",
    "ga_ai_kpi_vision_label":            "Cardano VISION 2030",
