...
UI_JA: dict[str, str] = {
    ...
    "staking_stat_total_stake":    "総ステーク",
    ...
    "staking_search_placeholder":  "ticker / プール名 / pool ID を検索...",
    "staking_sort_stake_desc":     "ステーク（多い順）",
...
UI_EN: dict[str, str] = {
    ...
    "staking_search_placeholder":  "Search by ticker / pool name / pool ID...",
    "staking_sort_stake_desc":     "Stake (high to low)",
