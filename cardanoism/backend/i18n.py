...
UI_EN: dict[str, str] = {
    ...
    "staking_why_v1_desc":          "Around 2-3% APY paid every 5 days (1 epoch) automatically into your wallet. Compounds nicely over time.",
